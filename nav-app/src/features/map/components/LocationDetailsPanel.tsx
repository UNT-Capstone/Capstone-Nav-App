...
export default function LocationDetailsPanel({
  ...
  return (
    <div className="fixed left-0 top-36 h-[calc(80vh-8rem)] w-72 bg-white shadow-2xl z-998 flex flex-col rounded-lg">
      {/* Header with Close Button */}
      <div className="flex items-center justify-between p-4 border-b">
        <h2 className="text-lg font-bold text-gray-800">Location Details</h2>
        <button
          onClick={onClose}
          className="p-4 hover:bg-gray-100 rounded-lg transition"
      ...
      <div className="border-t p-4 space-y-2">
        ...
        >
          <Heart size={18} fill={isAddedToFavorites ? "currentColor" : "none"} />
